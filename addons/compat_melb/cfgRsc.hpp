...
class RscInGameUI
{
    ...
    {
        /*class CA_Radar_MELB: RscControlsGroupNoScrollbars
        {
            idc = 2301;
            ...
            class controls
            {
                class CA_RadarIcon_MELB: RscPicture
                {
    ...
    {
        controls[] = {
            "CA_BackgroundVehicle","CA_BackgroundVehicleTitle","CA_BackgroundVehicleTitleDark","CA_BackgroundFuel","CA_Vehicle","CA_VehicleRole","CA_HitZones","CA_VehicleTogglesBackground","CA_VehicleToggles","CA_SpeedBackground","CA_SpeedUnits","CA_Speed","CA_ValueFuel","CA_AltBackground","CA_AltUnits","CA_Alt","WeaponInfoControlsGroupRight",
            "CA_Zeroing","CA_Mode",
        };

        onLoad="['onLoad',_this,'RscUnitInfo','IGUI'] call (uinamespace getvariable 'BIS_fnc_initDisplay');_this call IBC__MELB_fnc_handler";
    };
    ...
    {
        idd = 300;
        onLoad = "['onLoad',_this,'RscUnitInfo','IGUI'] call (uinamespace getvariable 'BIS_fnc_initDisplay'); _this spawn IBC__MELB_fnc_FLIRHandler";
        controls[] = {"MELB_GUI"};
    ...
    class Rsc_MELB_RTD_UnitInfo: RscUnitInfoAirRTD_NoRadar_MELB
    {
        ...
        onLoad="['onLoad',_this,'RscUnitInfoAirRTDFullNoWeapon','IGUI'] call (uinamespace getvariable 'BIS_fnc_initDisplay');_this call IBC__MELB_fnc_handler";
    };
};
